...
const char FP_GUI_XPT_SAMPLES[] PROGMEM       = "xpt_samples";
const char FP_GUI_XPT_DEBOUNCE[] PROGMEM      = "xpt_debounce";
const char FP_GUI_XPT_PRESSURE_MIN[] PROGMEM  = "xpt_pressure_min";
const char FP_GUI_XPT_SMOOTHING[] PROGMEM     = "xpt_smoothing_permille";
const char FP_GUI_XPT_PRESSURE_REF[] PROGMEM = "xpt_pressure_ref";
const char FP_GUI_XPT_PRESSURE_XCOEFF[] PROGMEM = "xpt_pressure_x_coeff";
const char FP_GUI_XPT_PRESSURE_YCOEFF[] PROGMEM = "xpt_pressure_y_coeff";
